...
public class Tabs {
	...
	public void setUp() {
		...
		wDWait = new WebDriverWait(wd,30);
		sf = new SoftAssert();
...
//	public void setWindowHandle(String handle, String allWindowHandle) {
//		String thirdWindowHandle = wd.getWindowHandle();
//		Set<String> allWindowHandless = wd.getWindowHandles();
//		for (String handle1 : allWindowHandless) {
//			if (!handle1.equals(thirdWindowHandle)) {
